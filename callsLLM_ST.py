...
ruta="salida/relacionesM/"+str(sys.argv[3])
...
salida="LLMs/"+str(sys.argv[1])+"/"+str(sys.argv[3]) +"ST/" # le agregue la ruta donde lo pondra validacion/
...
for c in range(muestreos):
    ...
    with open(salida+"rit_"+str(c+1)+"_ST.pickle", "wb") as f:
